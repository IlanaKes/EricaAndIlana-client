...
try:
    ...
    #turn left to yaw 5 degrees
    drone_client.move(0.0, 0.0, 0.5, 5.0, 2.0)  # 1
    #turn right to yaw -5 degrees
    drone_client.move(0.0, 0.0, 0.5, -5.0, 2.0) 
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0) 
    #turn left to yaw 7 degrees
    drone_client.move(0.0, 0.0, 0.5, 7.0, 2.0) #2
    #turn right to yaw -2 degrees
    drone_client.move(0.0, 0.0, 0.5, -3.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 9 degrees
    drone_client.move(0.0, 0.0, 0.5, 9.0, 2.0) #3
    #turn right to yaw -1 degrees
    drone_client.move(0.0, 0.0, 0.5, -1.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 11 degrees
    drone_client.move(0.0, 0.0, 0.5, 11.0, 2.0) #4
    #turn right to yaw 1 degrees
    drone_client.move(0.0, 0.0, 0.5, 1.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 13 degrees
    drone_client.move(0.0, 0.0, 0.5, 13.0, 2.0) #5
    #turn right to yaw 3 degrees
    drone_client.move(0.0, 0.0, 0.5, 3.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 15 degrees
    drone_client.move(0.0, 0.0, 0.5, 15.0, 2.0) #6
    #turn right to yaw 5 degrees
    drone_client.move(0.0, 0.0, 0.5, 5.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 17 degrees
    drone_client.move(0.0, 0.0, 0.5, 17.0, 2.0) #7
    #turn right to yaw 7 degrees
    drone_client.move(0.0, 0.0, 0.5, 7.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 19 degrees
    drone_client.move(0.0, 0.0, 0.5, 19.0, 2.0) #8
    #turn right to yaw 9 degrees
    drone_client.move(0.0, 0.0, 0.5, 9.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 21 degrees
    drone_client.move(0.0, 0.0, 0.5, 21.0, 2.0) #9
    #turn right to yaw 11 degrees
    drone_client.move(0.0, 0.0, 0.5, 11.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 2.0)
    #turn left to yaw 23 degrees
    drone_client.move(0.0, 0.0, 0.5, 23.0, 2.0) #10
    #turn right to yaw 13 degrees
    drone_client.move(0.0, 0.0, 0.5, 13.0, 2.0)
    #return to yaw 0 degrees
    drone_client.move(0.0, 0.0, 0.5, 0.0, 4.0)
    #graceful landing
